...
class FakeTCPController(object):
    ...
    def announce(self):
        ...
        device_name = "WIFI"
        static_ip_1, static_ip_2, static_ip_3, static_ip_4 = (192, 168, 0, 100)
